        ...
        <Container>
          <div className="p-16">
            <Typography variant="h4" className="font-extrabold">
              Fix<span className="text-purple-600">Chat</span>: The Future of IT
              Support
            </Typography>
            <div></div>
            ...
            <Grid container spacing={6} className="pt-8">
              <Grid item xs={12} md={4} className="flex">
                ...
                >
                  ...
                  >
                    Get immediate, expert guidance for any IT challenge. Simply
                    ask, and FixChat delivers the fix—quickly, effortlessly, and
                    accurately.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4} className="flex">
                ...
                >
                  ...
                  <Typography
                    ...
                    className="mt-4 font-medium text-slate-300"
                  >
                    Receive custom-tailored scripts that do the work for you.
                    Designed to tackle your specific issue with pinpoint
                    accuracy, FixChat’s solutions save time and get you back on
                    track faster.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4} className="flex">
                ...
                >
                  ...
                  <Typography
                    ...
                    className="mt-4 font-medium text-slate-300"
                  >
                    Unlock the power of professional-grade IT support. With
                    FixChat, you have access to solutions crafted for the
                    highest standards, giving you the confidence to solve any
                    problem.
                  </Typography>
                </Box>
              </Grid>
        ...
        <Container maxWidth="lg">
          <Box className="p-8 rounded-3xl shadow-lg text-center bg-slate-800 bg-opacity-70 backdrop-blur-sm overflow-hidden">
            ...
            <Typography variant="h4" paragraph className="font-bold">
              The Answer is Fix<span className="text-purple-600">Chat</span>.
              Always.
            </Typography>
          </Box>
        </Container>
      ...
      >
        <Container maxWidth="lg">
          <Box className="p-8 rounded-3xl shadow-lg text-center bg-slate-800 bg-opacity-70 backdrop-blur-sm">
            ...
            <Typography variant="h6" paragraph>
              At FixChat, we’re redefining IT support with cutting-edge
              technology and relentless focus on speed and simplicity. Our
              mission is to empower you with powerful solutions that make
      ...
      >
        <Container maxWidth="lg">
          <Box className="p-8 rounded-3xl shadow-lg text-center bg-slate-800 bg-opacity-70 backdrop-blur-sm">
            ...
            <Typography variant="h6" paragraph>
              Join the revolution of IT professionals who trust FixChat to
              supercharge their support process. Start using FixChat today and
              experience the future of IT solutions—fast, precise, and powerful.
            </Typography>
          </Box>
        </Container>
      </motion.div>
