          ...
          <div className="max-w-xl mx-auto text-center">
            <h1 className="text-4xl font-bold sm:text-6xl">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-white">
                {" "}
                FixChat <br /> The Future of IT Support{" "}
              </span>
            </h1>
            <p className="mt-5 text-base text-white sm:text-xl">
              No more waiting for a solution. Try FixChat, the AI based instant
              IT support.
            </p>
            ...
            <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm text-white">Over 12,000 joined</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm text-white">Safe and secure</p>
              </div>
            </div>
          </div>
        </motion.div>
