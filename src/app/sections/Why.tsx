    ...
    <section className="py-12 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-base leading-7 text-white/80 sm:mt-8 font-pj"></p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
            ...
            <h3 className="mt-12 text-xl font-bold text-white font-pj">
              Why Settle for Slow When You Can Have Instant?
            </h3>
            <p className="mt-5 text-base text-white/80 font-pj">
              FixChat delivers solutions at the speed of thought. Say goodbye to
              long waits and hello to lightning-fast IT problem-solving,
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-white font-pj">
              Why Waste Time When You Can Be Precise?
            </h3>
            <p className="mt-5 text-base text-white/80 font-pj">
              Every second counts. FixChat’s custom scripts are crafted for
              accuracy, ensuring you get the right solution, right now. It’s IT
